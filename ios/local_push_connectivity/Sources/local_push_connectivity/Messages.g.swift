...
protocol LocalPushConnectivityPigeonFlutterApiProtocol {
  func onMessage(message messageArg: MessageResponsePigeon, completion: @escaping (Result<Void, PigeonError>) -> Void)
}
